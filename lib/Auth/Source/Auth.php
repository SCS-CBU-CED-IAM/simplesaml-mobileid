	...
	protected function login($username, $language, $message) {
        ...
        if ($mobileIdRequest->response_error) {
            ...
            if ($erroris == '20901') {
                    ...
                    $mobileIdRequest->soap_request = '';
                    /* Reinitialize the error variables */
                    $mobileIdRequest->response_error = false;
                    $mobileIdRequest->response_error_type = false;
                    $mobileIdRequest->response_mss_status_code = '';
                    $mobileIdRequest->response_soap_fault_subcode = '';
                    $mobileIdRequest->response_status_message = '';
                    /* Recall */
                    $mobileIdRequest->sendRequest($this->msisdn, $this->language, $this->message);
            }
        }
